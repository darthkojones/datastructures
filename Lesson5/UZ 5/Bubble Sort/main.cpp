...
int main() {
    ...
    for (int k = 0; k < numArrays; ++k) {
        ...
        std::cout << "\nBubble Sort took: " << std::fixed << std::setprecision(6) << duration.count() << " seconds\n" << std::endl;
        logFile << "\nBubble Sort took: " << std::fixed << std::setprecision(6) << duration.count() << " seconds\n" << std::endl;
    ...
    std::cout << "Average Bubble Sort time: " << std::fixed << std::setprecision(6) << averageSortTime << " seconds" << std::endl;
    logFile << "Average Bubble Sort time: " << std::fixed << std::setprecision(6) << averageSortTime << " seconds" << std::endl;
